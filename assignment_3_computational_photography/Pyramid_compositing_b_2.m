...
im_left  = im2double(imread('images_pyramid_b/bob_mask_6.png'));
...
im_right  = im2double(imread('images_pyramid_b/bob3.jpg')); 
%im_left = im2double(imread('images_pyramid_b/poa_at_night.jpg')); 
im_left = im2double(imread('images_pyramid_b/protest.jpg')); 
%imshow(mask0);
%imtool(im_left);
...
%im_left  = im2double(imread('images_pyramid_b/sun_in_sky.jpg')); 
%im_left  = im2double(imread('images_pyramid_b/images_sun.jpg'));
im_left  = im2double(imread('images_pyramid_b/sun_mask_3.jpg')); 
...
%im_right  = im2double(imread('images_pyramid_b/images_sun.jpg')); 
%im_right  = im2double(imread('images_pyramid_b/sun_in_sky.jpg')); 
im_right  = im2double(imread('images_pyramid_b/sun.jpg')); 
im_left = im_out; 
