...
Utilizando o comando cond do Matlab que retorna o ondicionamento de uma
matriz segundo uma norma matricial retornou um valor extremamente alto, 
1.4951e+07, justificando o mal condicionamento da matrix de Hilbert.
%}
